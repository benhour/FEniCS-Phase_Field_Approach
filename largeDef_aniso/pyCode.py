...
BoundaryU = Expression(('gam*x[1] + 1e-3*t'), gam = 0.08, t = 0, degree = 1)
...
res = (detta_dt*eta_)*dx + 1*(dF + mech_form)
...
etaFile = File("resultsLI/eta.pvd")
uFile = File("resultsLI/u.pvd")
# sigma_file = File("resultsLI/sig.pvd")
